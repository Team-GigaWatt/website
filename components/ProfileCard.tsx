      ...
      <div ref={shellRef} className="relative z-[1] group w-full h-full">
        ...
        >
          ...
          >
            ...
            >
              <img
                ...
                style={{
                  ...
                  transform:
                    'translateX(calc((var(--pointer-from-left) - 0.5) * 12px)) translateY(calc((var(--pointer-from-top) - 0.5) * 12px)) translateZ(0) scale(1.05)',
                  borderRadius: cardRadius,
                  backfaceVisibility: 'hidden'
                }}
                onError={e => {
              ...
              {showUserInfo && (
                <div
                  className="absolute z-[2] flex items-center justify-between backdrop-blur-[20px] border border-white/10 pointer-events-auto"
                  style={
                    {
                      '--ui-inset': '20px',
                      '--ui-radius-bias': '6px',
                ...
                >
                  <div className="flex items-center gap-2 md:gap-3 min-w-0 flex-1 pr-2">
                    ...
                    <div className="flex flex-col items-start gap-1 min-w-0 flex-1">
                      <div className="text-[13px] md:text-sm font-medium text-white/90 leading-none truncate w-full">{handle}</div>
                      <div className="text-[12px] md:text-sm text-white/70 leading-none truncate w-full">{status}</div>
                    </div>
                  </div>
                  <button
                    className="border border-white/10 rounded-lg px-15 py-12 text-sm font-regular text-white/90 cursor-pointer backdrop-blur-[10px] transition-all duration-200 ease-out hover:border-white/40 hover:-translate-y-px"
            ...
            >
              <div className="w-full absolute flex flex-col items-center justify-center text-center inset-x-0" style={{ top: '55%', gridArea: 'auto' }}>
                <h3
                ...
                <p
                  className="font-semibold whitespace-nowrap text-center mx-auto"
                  style={{
                    position: 'relative',
                    top: '-6px',
                    fontSize: '16px',
